...
"""Pull-specific scheduler-side logic for the P2P connector."""
...
class P2pPullConnectorScheduler(P2pBaseConnectorScheduler):
    ...
    def get_num_new_matched_tokens(
        ...
        logger.debug(
            "P2PConnector get_num_new_matched_tokens: "
    ...
    def update_state_after_alloc(
        ...
        params = request.kv_transfer_params
        logger.debug(
            "P2PConnector update_state_after_alloc: "
        ...
        if self.use_host_buffer and params.get("do_remote_decode"):
            # NOTE: when accelerator is not directly supported by P2p,
    ...
    def request_finished(
        ...
        params = request.kv_transfer_params
        logger.debug(
            "P2PConnector request_finished(%s), request_status=%s, "
        ...
        if delay_free_blocks:
            ...
            logger.debug(
                "P2PConnector request_finished(%s) waiting for %d seconds "
